  ...
  async processProposal(proposalText) {
      ...
      try {
          ...
          if (data.success && data.result && data.result.response) {
              ...
              // ONLY use one UI update method - choose the modern conversation UI
              ...
              try {
                  ...
                  console.error('Speech generation/playback error:', speechError);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Set up send button (for the modern UI)
  const sendButton = document.getElementById('send-btn');
  const terminalInput = document.getElementById('terminal-input');
  
  if (sendButton && terminalInput) {
